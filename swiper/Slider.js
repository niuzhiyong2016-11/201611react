   ...
   go(step){
       ...
       /* if(this.state.index >= this.state.images.length){
        ...
        this.setState({index:this.state.index},()=>{
            console.log(this.state.index ,this.state.images.length);
  ...
  render(){
     return (
             <div className="slider" onMouseOver={this.handleMouseOver.bind(this)} onMouseOut={this.handleMouseOut.bind(this)}>
                 <ul ref="items" className="items" style={{width:(this.state.images.length*1000)+'px',transitionDuration:'1s',left:(this.state.index*-1000)+'px'}}>
                     {
